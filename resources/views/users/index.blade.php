    ...
    <div class="card bg-dark border-secondary shadow-lg rounded-4 mb-4">
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                ...
                <form action="{{ route('users.index') }}" method="GET" class="d-flex" style="width:500px; gap:10px;">

                    <!-- STATUS FILTER ADDED -->
                    <select name="status" class="form-control bg-black text-light border-secondary" style="max-width:150px;">
